...
export const OAUTH_EBAY_ENV = process.env.REACT_APP_OAUTH_EBAY_ENV // || 'SANDBOX' // SANDBOX or PRODUCTION
export const OAUTH_EBAY_ID = process.env.REACT_APP_OAUTH_EBAY_ID || 'ALYS-alysmvp-PRD-4ee906e47-1dd7c0fd'
export const OAUTH_EBAY_DEV_ID = process.env.REACT_APP_OAUTH_EBAY_DEV_ID || '8340e499-5c62-4eea-a78f-3fc234412fa1'
export const OAUTH_EBAY_SECRET = process.env.REACT_APP_OAUTH_EBAY_SECRET || 'PRD-ee906e4701dd-b6f6-4c87-ba17-3a82'
export const EBAY_RU_NAME =
  process.env.REACT_APP_EBAY_RU_NAME || 'ALYS-ALYS-alysmvp-PR-remwqbrnv'

export const OAUTH_EBAY_SBX_ID = process.env.REACT_APP_OAUTH_EBAY_SBX_ID || 'ALYS-alysmvp-SBX-4ee99cdfb-a6ab29ef'
export const OAUTH_EBAY_SBX_DEV_ID = process.env.REACT_APP_OAUTH_EBAY_SBX_DEV_ID || 'ALYS-alysmvp-SBX-4ee99cdfb-a6ab29ef'
export const OAUTH_EBAY_SBX_SECRET = process.env.REACT_APP_OAUTH_EBAY_SBX_SECRET || 'SBX-ee99cdfbd0ff-f47f-4efc-9fe6-97ce'
export const EBAY_SBX_RU_NAME =
  process.env.REACT_APP_EBAY_SBX_RU_NAME || 'ALYS-ALYS-alysmvp-SB-qhmxo'
