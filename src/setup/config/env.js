...
export const OAUTH_EBAY_ENV = process.env.REACT_APP_OAUTH_EBAY_ENV
export const OAUTH_EBAY_ID = process.env.REACT_APP_OAUTH_EBAY_ID
export const OAUTH_EBAY_DEV_ID = process.env.REACT_APP_OAUTH_EBAY_DEV_ID
export const OAUTH_EBAY_SECRET = process.env.REACT_APP_OAUTH_EBAY_SECRET
export const EBAY_RU_NAME = process.env.REACT_APP_EBAY_RU_NAME

export const OAUTH_EBAY_SBX_ID = process.env.REACT_APP_OAUTH_EBAY_SBX_ID
export const OAUTH_EBAY_SBX_DEV_ID = process.env.REACT_APP_OAUTH_EBAY_SBX_DEV_ID
export const OAUTH_EBAY_SBX_SECRET = process.env.REACT_APP_OAUTH_EBAY_SBX_SECRET
export const EBAY_SBX_RU_NAME = process.env.REACT_APP_EBAY_SBX_RU_NAME
